...
// Declare a regular expression for sanity checking the format of all email
// addresses (we'll use this later in the book). If you're interested, this
// regular expression pattern is take from
// https://html.spec.whatwg.org/#invalid-e-mail-address.
var (
  EmailRX =
